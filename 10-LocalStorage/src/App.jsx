...
const App = () => {
 ...
 const user =  localStorage.setItem('user',JSON.stringify(user2))  //json.stringify is used to convert the object into string cause object is not readable inform of pair   
